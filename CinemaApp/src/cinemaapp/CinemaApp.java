/*
Group Members   : Fang Xiang Lun, Loh Chia Heung, Teh Jun Yuan
ID              : D200221C, D200262C, D200248C
Create date     : 16-7-22
...
public class CinemaApp {
    public static void main(String[] args) {
        ...
        String pw="example";
        int option;
        boolean yn=true; //use for looping
        //-----data field-----
        int movieType;
        String name;
        String actor="";
        ...
        try{
            ...
            while((!role.equals("ADMIN")) && !role.isEmpty()){
            ...
            //main label (entire app) break main: will exit to this label brace, but skip this if else (if no change made)
            main:
